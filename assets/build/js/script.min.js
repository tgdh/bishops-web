...
g+=c,f++,$(e).html(g.toFixed(a.decimals)),"function"==typeof a.onUpdate&&a.onUpdate.call(e,g),f>=b&&(clearInterval(h),g=a.to,"function"==typeof a.onComplete&&a.onComplete.call(e,g))}var e=this,f=0,g=a.from,h=setInterval(d,a.refreshInterval)})},$.fn.countTo.defaults={from:0,to:100,speed:1e3,refreshInterval:100,decimals:0,onUpdate:null,onComplete:null},b.hasClass("Infographic")&&$(".js-fig__val").bind("inview",function(b,c,d,e){if(c&&"top"!=e&&"bottom"!=d){var f=($(this),$(this).data("to"));$(this).countTo({from:0,to:f,speed:500,refreshInterval:50,onComplete:function(){}})}a($(".graphic--envelopes"),"animate")})};e(),$(".tooltip__marker").tooltipster({theme:"tooltipster-bishops"}),$(document).ready(function(){f(),g()}),$(".floatlabel").jvFloat(),$(".owl-carousel.case-study").owlCarousel({nav:!0,navText:['<i class="ico-arrow-left"></i>','<i class="ico-arrow-right"></i>'],items:1,autoplay:!1,dots:!0,loop:!0,animateOut:"fadeOut"}),$(".gallery").magnificPopup({delegate:"a",type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.',titleSrc:function(a){return a.el.attr("title")}}})});